	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/usdt/status/:trade_no", controller.GetUsdtOrderStatus)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/topup/admin", controller.AdminManualTopUp)
		...
		// User discount management (root only)
		userDiscountRoute := apiRouter.Group("/user_discount")
		userDiscountRoute.Use(middleware.RootAuth())
		{
			userDiscountRoute.GET("/", controller.ListUserDiscounts)
			userDiscountRoute.POST("/", controller.CreateUserDiscount)
			userDiscountRoute.PUT("/:id", controller.UpdateUserDiscount)
			userDiscountRoute.DELETE("/:id", controller.DeleteUserDiscount)
		}
